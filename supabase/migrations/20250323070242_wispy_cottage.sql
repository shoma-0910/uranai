/*
  # Fix Admin Access and Functions

  1. Changes
    - Update admin user type if exists instead of inserting
    - Add admin functions for managing users
...
-- First, ensure we have an admin user by updating or inserting
DO $$ 
BEGIN
  -- Try to update existing user to admin if exists
  UPDATE profiles 
  SET user_type = 'admin',
